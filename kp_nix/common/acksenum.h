...
enum AckTypes
{
	...
	ackModeDu				= 112,			//    •	112(0x70) - перевод КП в режим ДУ  												НАЧИНАЯ С ВЕРСИИ 2.0.0.310, 1.0.7.33 КП
	ackModeSu				= 113,			//    •	113(0x71) - перевод КП в режим СУ  		  										НАЧИНАЯ С ВЕРСИИ 2.0.0.310, 1.0.7.33 КП
	ackModeRsu				= 114,			//    •	114(0x72) - перевод КП в режим РСУ 		  										НАЧИНАЯ С ВЕРСИИ 2.0.0.310, 1.0.7.33 КП
	ackModeRu				= 115,			//    •	115(0x73) - перевод КП в режим РУ  		  										НАЧИНАЯ С ВЕРСИИ 2.0.0.310, 1.0.7.33 КП
	ackTuDisabledRu			= 116,			//    •	116(0x74) - ТУ отвергнута (режим РУ)	  										НАЧИНАЯ С ВЕРСИИ 2.0.0.310, 1.0.7.33 КП
	ackTuDisabledDu			= 117,			//    •	117(0x75) - ТУ отвергнута (запреит ТУ от АРМ ДНЦ в конфигурации КП)				НАЧИНАЯ С ВЕРСИИ 2.0.0.310, 1.0.7.33 КП
	ackCmdDisabled			= 118,			//    •	118(0x76) - директива отвергнута - АРМ ДСП не активен 							НАЧИНАЯ С ВЕРСИИ 2.0.0.310, 1.0.7.33 КП

	tuPrcAckRcv				= 119,			//	  • 119(0x77) - ТУ для РПЦ принята   												НАЧИНАЯ С ВЕРСИИ 2.0.0.335, 1.0.7.35 КП 		
	tuPrcAckRcvTodo			= 120,			//	  • 120(0x77) - ТУ для РПЦ принята к исполнению   									НАЧИНАЯ С ВЕРСИИ 2.0.0.335, 1.0.7.35 КП 
	tuPrcAckIgnore1			= 121,			//	  • 121(0x79) - ТУ для РПЦ отвергнута (нет готовности РПЦ)   						НАЧИНАЯ С ВЕРСИИ 2.0.0.335, 1.0.7.35 КП 
	tuPrcAckIgnore2			= 122,			//	  • 122(0x7a) - переполнение очереди ТУ РПЦ   										НАЧИНАЯ С ВЕРСИИ 2.0.0.335, 1.0.7.35 КП 
