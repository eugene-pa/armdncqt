...
public:
    ...
    static Train * GetBySysNo(int sno);                     // получить справочник по номеру РЦ
    static Train * AddTrain(int sno, int no=0);             // получить справочник по номеру РЦ
...
// 2011.12.23. информация, полученная от ГИД УРАЛ (номер и индекс пишем в штатные поля)
    ...
    DWORD guLokno;										// номер локомотива
