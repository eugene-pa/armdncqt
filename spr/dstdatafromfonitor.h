...
// -------------------------------------------------------------------------------------------------
    int 	CntLinkEr	[DUBL];					// Общий счетчик ошибок связи						408/792
    ...
    union
    {
        int     speedCom3l;                     // 4 байта полной скорости для КП2000
    ...
    union
    {
        int     speedCom4l;                     // 4 байта полной скорости для КП2000
